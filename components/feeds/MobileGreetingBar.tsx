    ...
    <div className="bg-primary px-4 pb-20 pt-4 lg:hidden">
      <div className="flex items-center justify-between gap-3">
        ...
        <Link
          ...
          className="relative flex size-10 shrink-0 items-center justify-center rounded-full text-white transition hover:bg-white/10"
        >
          <Bell className="size-5" />
          {unreadCount > 0 && (
            <span className="absolute right-1.5 top-1.5 flex size-4 items-center justify-center rounded-full bg-secondary text-[10px] font-semibold text-white ring-2 ring-primary">
              {unreadCount}
            </span>
          )}
        </Link>
