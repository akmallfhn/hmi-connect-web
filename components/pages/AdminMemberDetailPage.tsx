...
// Read-only mirror of AdminUserDetailPage — no edit/delete/access-management affordances.
export default function AdminMemberDetailPage({
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <Link href={`${basePath}/members`} className="inline-block w-fit">
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 xl:grid-cols-2">
        ...
        <SectionCard title="Organisasi">
          ...
          <Field label="Korkom" value={user.coordinating_chapter_name} />
