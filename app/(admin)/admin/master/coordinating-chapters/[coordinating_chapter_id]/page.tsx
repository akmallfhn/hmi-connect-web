...
interface MasterCoordinatingChapterDetailPageProps {
...
export default async function MasterCoordinatingChapterDetailPage({
  params,
  searchParams,
}: MasterCoordinatingChapterDetailPageProps) {
